//
// Example of GLSL Minneart shader.
//
...
void	animate ()
{
	...
	light.x = 4*cos ( angle );
	light.y = 5*sin ( 1.4 * angle );
	light.z = 5 + 0.5 * sin ( angle / 3 );
...
int main ( int argc, char * argv [] )
{
	...
	glutInitWindowSize  ( 500, 500 );
								...
								// create window
	glutCreateWindow ( "Minneart Lighting Model" );
	...
	if ( !program.loadShaders ( "Minnaert.vsh", "Minnaert.fsh" ) )
	{
